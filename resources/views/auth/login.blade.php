                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="position-relative mt-3 form-input">
                        <div class="input-group mb-3">
                            ...
                            <input type="username" name="username" class="form-control" placeholder="Masukkan Username" aria-label="Email" aria-describedby="basic-addon1" value="{{ old('username') }}" required>
                          </div>
